...
class TwitterAPICaller: BDBOAuth1SessionManager {
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "I_REMOVE_THE_API_KEY", consumerSecret: "I_REMOVE_THE_API_KEY_SECRET")
    var loginSuccess: (() -> ())?
